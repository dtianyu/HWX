...
import com.hwx.ejb.PurchaseTransactionBean;
...
import com.hwx.lazy.PurchaseTransactionModel;
 ...
 * @author kevindong
 */
@ManagedBean(name = "purchaseTransactionManagedBean")
@SessionScoped
public class PurchaseTransactionManagedBean extends SuperSingleBean<PurchaseTransaction> {
    ...
    public PurchaseTransactionManagedBean() {
    ...
    protected boolean doBeforePersist() throws Exception {
        ...
        if (this.getNewEntity().getVendor() == null) {
    ...
    @Override
    public void init() {
        this.superEJB = purchaseTransactionBean;
