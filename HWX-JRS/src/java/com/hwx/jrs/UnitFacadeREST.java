 ...
 */
@Stateless
@Path("com.hwx.entity.unit")
public class UnitFacadeREST extends AbstractFacade<Unit> {

    @PersistenceContext(unitName = "HWX-JRSPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Unit entity) {
        super.edit(entity);
    }
    ...
    public Unit find(@PathParam("id") Integer id) {
